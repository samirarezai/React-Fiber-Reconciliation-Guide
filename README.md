...
A study guide for **React Fiber**, the **reconciliation** algorithm, and how **React 19** fits next to **React 16–18**. Diagrams use [Mermaid](https://mermaid.js.org/) so they render as figures on GitHub, GitLab, and many IDEs.
